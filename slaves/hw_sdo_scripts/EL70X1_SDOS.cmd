...
#- Set max current [mA]
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x1,${I_MAX_MA_VALID},2)"
epicsEnvUnset(I_MAX_MA_VALID)

#- Reduced current [mA]
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x2,${I_STDBY_MA_VALID},2)"
epicsEnvUnset(I_STDBY_MA_VALID)

#- Nominal voltage [mV]
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x3,${U_NOM_MV_VALID},2)"
...
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x4,${R_COIL},2)"
epicsEnvUnset(R_COIL)
epicsEnvUnset(R_COIL_MOHM)
epicsEnvUnset(MOT_R_COIL_MOHM)

#- Motor steps []
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x6,${STEPS=${MOT_STEPS=200}},2)"
epicsEnvUnset(MOT_STEPS)
epicsEnvUnset(STEPS)

#- Motor EMF  mV/(rad/s)
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x5,${EMF=${MOT_EMF=0}},2)"
