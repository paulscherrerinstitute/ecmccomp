...
#- Nominal voltage
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x19,${U_NOM_MV_VALID},4)"
epicsEnvUnset(U_NOM_MV_VALID)

#- Motor max current
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8011,0x11,${I_MAX_MA_VALID},4)"
epicsEnvUnset(I_MAX_MA_VALID)

#- Motor rated current
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8011,0x12,${I_NOM_MA=${MOT_I_NOM_MA}},4)"
