...
#-d     pattern {  SLAVE_ID, HW_DESC, COMP,                                    COMP_CH, COMP_MACROS                   }
#-d             {  1,        EL3004,  -1,                                      -1,      -1                            }
#-d             {  2,        EL5001,  -1,                                      -1,      -1                            }
#-d             {  3,        EL1008,  -1,                                      -1,      -1                            }
#-d             {  4,        EL7031,  "Motor-OrientalMotor-PK267JB-Parallel",   1,      "I_MAX_MA=500,I_STDBY_MA=100" }
#-d             {  12,       EL7037,  "Motor-OrientalMotor-PK267JB-Parallel",   1,      "I_MAX_MA=500,I_STDBY_MA=100" }
#-d     }
#-d
