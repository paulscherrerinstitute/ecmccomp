#-d /**
#-d   \brief Script for Encoder-RLS-LA11-26bit
#-d   \details RLS Biss-C 26-bit encoder, sends a 26-bit position, while lower resolution models fix the LSB to 0.
#-d   \author Felix Maier 
#-d   \file
#-d   \note Supply:     5 V
#-d */
