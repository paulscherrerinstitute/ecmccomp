#-d /**
#-d   \brief hardware script for motor Beckhoff AM8113-XXX1
#-d   \details Parametrization of motor Beckhoff AM8113-XXX1
...
epicsEnvSet(MOT_ROT_INERTIA_GCM2,89)

#- Brake Application delay
epicsEnvSet(MOT_BRK_APP_DLY,14)
