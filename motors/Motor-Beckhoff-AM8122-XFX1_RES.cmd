#-d /**
#-d   \brief hardware script for motor Beckhoff AM8122-XFX1
#-d   \details Parametrization of motor Beckhoff AM8122-XFX1
...
#- Max Current [mA]
epicsEnvSet(MOT_I_MAX_MA,22400)
...
epicsEnvSet(MOT_ROT_INERTIA_GCM2,325)
