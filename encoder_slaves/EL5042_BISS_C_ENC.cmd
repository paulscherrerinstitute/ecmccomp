...
#- Supported macros
#- epicsEnvSet(SUPP_MACROS,"CLK_FRQ_KHZ,INV_DIR,U_SUP_VLT,CODING,MT_BITS,OFF_BITS,CRC_INV,DIS_STAT_BITS,CRC_POLY")
...
epicsEnvSet(SUPP_MACROS,"CLK_FRQ_KHZ,INV_DIR,CODING,MT_BITS,OFF_BITS,CRC_INV,DIS_STAT_BITS,CRC_POLY")
