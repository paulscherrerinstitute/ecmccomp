#==============================================================================
# MO7221_OCT_SDOS_EL72XX_OCT_SERVO.cmd
#-d /**
#-d   \brief Motor SDOs for the MO7221 OCT drive
#-d   \details Equivalent to the EL72XX OCT motor setup except that the
#-d            fixed-voltage MO7221 has no object 0x8010:19.
#-d   \author Anders Sandström
#-d   \file
#-d */

#- The MO7221-9016 supply is fixed at 24 V; consume the validated value without
#- attempting the EL72XX nominal-voltage write at 0x8010:19.
...
#- Motor thermal time constant [0.1 s]
...
#- Current-loop proportional gain [0.1 V/A]
